...
- **Новое**: Кеширование внешних запросов на 1 час
...
- ✅ **Новое в 1.3.0**: Кеширование внешних запросов
...
### История версий
- **1.3.0** - Поддержка внешних JSON из GitHub, REST API, кеширование, трехвкладочный интерфейс
