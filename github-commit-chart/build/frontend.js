...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Отладочный вывод настроек плагина
    console.log('GitHub Commit Chart: Settings loaded', githubCommitChartSettings);
    ...
    function createCommitChart(container, githubProfile) {
        ...
        console.log('GitHub Commit Chart: Sending AJAX request to', githubCommitChartSettings.ajaxUrl);
        console.log('GitHub Commit Chart: Request params', params);
        ...
        xhr.onload = function() {
            ...
            console.log('GitHub Commit Chart: AJAX response received', xhr.status, xhr.responseText);
            ...
            if (xhr.status === 200) {
                try {
                    ...
                    console.error('GitHub Commit Chart: Parse error', e);
                }
            } else {
        ...
        xhr.onerror = function() {
            ...
            console.error('GitHub Commit Chart: Network error');
        };
    ...
    function renderCommitChartHeatmap(container, commitData) {
        ...
        if (!chartContainer) {
            console.error('GitHub Commit Chart: Chart container not found');
            return;
        }
        ...
        console.log('GitHub Commit Chart: Rendering chart with data', commitData);
